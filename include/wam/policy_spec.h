...
enum class ResampleBoundaryMode { truncate = 0, clamp };
enum class ImageCompositionKind { none = 0, canvas };
enum class ColorSpace { rgb = 0 };
enum class PixelRange { zero_to_one = 0, minus_one_to_one };
enum class TensorLayout { chw = 0, hwc };
enum class NormalizationKind { none = 0, z_score, min_max, quantile };
enum class LanguageInputMode { tokens = 0, embedding, tokens_or_embedding };
enum class SequenceSide { left = 0, right };
...
enum class ActionFrame { unknown = 0, world, robot_base, eef, controller };
enum class GripperEncoding { none = 0, continuous, discrete };
enum class ActionRecoveryKind { identity = 0, add_current_state };
...
struct ImageSpec {
    ...
    ResampleBoundaryMode resample_boundary = ResampleBoundaryMode::truncate;
};
